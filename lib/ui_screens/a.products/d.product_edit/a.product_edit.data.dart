...
class ProductEditData {
  ...
  final rxName =
      RM.injectTextEditing(text: Prov.products.st.rxProductDetail.st!.name, validateOnTyping: true, validators: [
    Validate.isNotEmpty,
    Validate.fullName,
  ]);
  final rxDescription =
      RM.injectTextEditing(text: Prov.products.st.rxProductDetail.st!.description, validateOnTyping: true, validators: [
    Validate.isNotEmpty,

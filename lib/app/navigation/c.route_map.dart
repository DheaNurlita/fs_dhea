...
class RouteMap {
  ...
  static final data = {
    ...
    Routes.tryList: (RouteData data) => const TryListView(),
    Routes.tryAdd: (RouteData data) => const TryAddView(),
    Routes.tryDetail: (RouteData data) => const TryDetailView(),
    Routes.tryEdit: (RouteData data) => const TryEditView(),
  };
}
